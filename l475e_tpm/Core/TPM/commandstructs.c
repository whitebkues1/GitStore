...
static uint8_t _TPM_GetCap_PROP_OWNER[] = "TPM_GetCap_PROP_OWNER"; 
static uint8_t __TPM_GetCap_PROP_OWNER[] =
{	
	0x00, 0xc1,
	0x00, 0x00, 0x00, 0x16,
	0x00, 0x00, 0x00, 0x65,
...
static uint8_t _physPres_notpresent[]  = "physPres_notpresent";
static uint8_t __physPres_notpresent[]  =
{
	0x00, 0xC1,
	0x00, 0x00, 0x00, 0x0C,
	0x40, 0x00, 0x00, 0x0A,
...
/**10.10 ����**/
static uint8_t _generateRandN[] = "generateRandN";
static uint8_t __generateRandN[] = 
{
	0x00, 0xC1,
	0x00, 0x00, 0x00, 0x0C,
	0x00, 0x00, 0x00, 0x99,
...
TPM_Command commandTable[] =
{
	...
	tableEnt(startupState,			1,							AUTH0,		HAND0,			HAND0)
	tableEnt(contSelfTest,			TPM_CMD_CONT_SELFTEST,		AUTH0,		HAND0,			HAND0)
	tableEnt(forceClear,			TPM_CMD_FORCE_CLEAR,		AUTH0,		HAND0,			HAND0)
	tableEnt(OIAP,					TPM_CMD_OIAP,				AUTH0,		HAND0,			HAND0)
	tableEnt(OSAP_ET_KH_SRK,		TPM_CMD_OSAP_ET_KH_SRK,		AUTH0,		HAND0,			HAND0)
	tableEnt(OSAP_ET_Key_SRK,		TPM_CMD_OSAP_ET_KEY_SRK,	AUTH0,		HAND0,			HAND0)
	tableEnt(OSAP,					TPM_CMD_OSAP,				AUTH0,		HAND0,			HAND0)
	tableEnt(createEKPair,			TPM_CMD_CREATE_EKPAIR,		AUTH0,		HAND0,			HAND0)
	tableEnt(readEK,				TPM_CMD_READKEY,		    AUTH0,		HAND0,			HAND0)
	tableEnt(createWrapKey,			TPM_CMD_CREATE_WRAPKEY,		AUTH1,		HAND1,			HAND0)
	tableEnt(createWrapKey_PCR,		TPM_CMD_CREATE_WRAPKEY_PCR,	AUTH1,		HAND1,			HAND0)
	tableEnt(loadKey,				TPM_CMD_LOADKEY,			AUTH1,		HAND1,			HAND1)
	tableEnt(flushKey,				TPM_CMD_FLUSHKEY,			AUTH0,		HAND0,			HAND0)
	tableEnt(takeOwnership,			TPM_CMD_TAKE_OWNERSHIP,		AUTH1,		HAND0,			HAND0)
	tableEnt(getPubKey,				TPM_CMD_GET_PUB_KEY,		AUTH1,		HAND1,			HAND0)
	tableEnt(bindV20,				TPM_CMD_BINDV20_G,			AUTH0,		HAND0,			HAND0)
	tableEnt(seal,					TPM_CMD_SEAL,				AUTH1,		HAND1,			HAND0)
	tableEnt(unSeal,				TPM_CMD_UNSEAL,				AUTH2,		HAND1,			HAND0)
	tableEnt(sign,					TPM_CMD_SIGN,				AUTH1,		HAND1,			HAND0)
	tableEnt(verifySign,			TPM_CMD_VERIFY_SIGN,		AUTH0,		HAND0,			HAND0)
	tableEnt(physPres_present,		TPM_CMD_PHYSPRES_PRESENT,	AUTH0,		HAND0,			HAND0)
	tableEnt(physEnable,			TPM_CMD_PHYS_ENABLE,		AUTH0,		HAND0,			HAND0)
	tableEnt(physDisable,			TPM_CMD_PHYS_DISABLE,		AUTH0,		HAND0,			HAND0)
	tableEnt(physSetDeact_false,	TPM_CMD_PHYS_SET_DEACT_FALSE, AUTH0,	HAND0,			HAND0)
	tableEnt(physSetDeact_true,		TPM_CMD_PHY_SET_DEACT_TRUE,	  AUTH0,	HAND0,			HAND0)
	tableEnt(reset,					TPM_CMD_RESET,				AUTH0,		HAND0,			HAND0)
	tableEnt(getSetMem,				TPM_CMD_GET_SET_MEM,		AUTH0,		HAND0,			HAND0)
	tableEnt(getCap_versVal,		TPM_CMD_GET_CAP_VERSVAL,	AUTH0,		HAND0,			HAND0)
	tableEnt(getCap_version,		TPM_GETCAP_VERSION,			AUTH0,		HAND0,			HAND0)
	tableEnt(terminateHandle0,		TPM_CMD_TERMINATE_HANDLE0,	AUTH0,		HAND0,			HAND0)
	tableEnt(terminateHandle1,		TPM_CMD_TERMINATE_HANDLE1,	AUTH0,		HAND0,			HAND0)
	tableEnt(TPM_GetCap_PROP_OWNER,	TPM_CMD_GET_CAP_PROP_OWNER,		AUTH0,		HAND0,			HAND0)
	tableEnt(physPres_notpresent,	TPM_CMD_PHYSPRES_NOTPRESENT,		AUTH0,		HAND0,			HAND0)
	/*10.10����*/
	tableEnt(generateRandN,  TPM_GET_BIG_PRIME_128,                          AUTH0,      HAND0,          HAND0)
	
	
	/* generic version for demo */
	{ _bindV20_g, __bindV20, sizeof(__bindV20), AUTH0, HAND0, HAND0 },
...
TPM_FuncPtr FuncPtrTable[] =
{
	...
	tableEntFuncPtr(physPres_notpresent,	genericFunc)
	...
	tableEntFuncPtr(TPM_GetCap_PROP_OWNER,  genericFunc)
	/*10.10����*/
	tableEntFuncPtr(generateRandN,   generateRandom128)
		
    /* generic version for demo */
	{ 	_bindV20_g, genericFunc},	
